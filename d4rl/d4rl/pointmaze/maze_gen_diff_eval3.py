...
class MazeGenDiffEval3(mujoco_env.MujocoEnv, utils.EzPickle, offline_env.OfflineEnv):
    def __init__(
    ...
    def is_reached(self, ob):
        ...
        return 1.0 if np.linalg.norm(ob[0:2] - ob[-2:]) <= 0.4 else 0.0
